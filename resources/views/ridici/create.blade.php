@extends('layouts.app', ['title' => 'Nový řidič'])
@section('header', 'Nový řidič')

@section('content')
    <form method="POST" action="{{ route('ridici.store') }}" class="max-w-2xl">
        @csrf
        @include('ridici._form', ['driver' => null])
